...
export const API_MODEL_MAP: Record<ProviderOption, Record<string, string>> = {
  huggingface: {
    ...
    "qwen-image-21": "qwen-image-21", // generate
    "qwen-image-21-edit": "qwen-image-21-edit", // edit (internal)
    "qwen-image-21-prompt-enhancer": "qwen-image-21-prompt-enhancer", // text (prompt enhance)
...
export const HF_MODEL_OPTIONS = [
  ...
  { value: "qwen-image-21", label: "Qwen Image 2.1" },
...
export const getModelConfig = (
  ...
  if (provider === "gitee") {
    ...
    if (model === "qwen-image-21") return { min: 4, max: 40, default: 40 };
...
export const EDIT_MODELS: UnifiedModelOption[] = [
  {
    ...
    value: "huggingface:qwen-image-21-edit",
...
export const TEXT_MODELS: UnifiedModelOption[] = [
  {
    label: "Qwen Image 2.1 PE",
    value: "huggingface:qwen-image-21-prompt-enhancer",
    provider: "huggingface",
  },
  {
